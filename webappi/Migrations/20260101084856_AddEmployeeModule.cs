    ...
    public partial class AddEmployeeModule : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ErpDepartments", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ErpEmployees_A_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "A_Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ErpEmployees_ErpDepartments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "ErpDepartments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ErpEmployees_ErpDesignations_DesignationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ErpEmployees_DepartmentId",
                table: "ErpEmployees",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ErpEmployees_DesignationId",
                table: "ErpEmployees",
                column: "DesignationId");

            migrationBuilder.CreateIndex(
                name: "IX_ErpEmployees_UserId",
                table: "ErpEmployees",
                column: "UserId");
        }
